...
const Navbar = () => {
    ...
    return (
        <nav className='fixed top-4 z-50 flex min-h-14 w-full max-w-5xl items-center justify-between rounded-full bg-blue-950 bg-opacity-20 px-6 backdrop-blur-sm'>
